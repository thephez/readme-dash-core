...
|                                                | ← | [`getdata` message](core-ref-p2p-network-data-messages.md#sectiongetdata) (qcontrib) | Peer(s) respond with request for quorum contribution
| [`qcontrib` message](core-ref-p2p-network-quorum-messages.md#sectionqcontrib)                             | → |                              | Masternode sends the requested quorum contribution
...
|                                                | ← | [`getdata` message](core-ref-p2p-network-data-messages.md#sectiongetdata) (qcomplaint) | Peer(s) respond with request for quorum complaints
| [`qcomplaint` message](core-ref-p2p-network-quorum-messages.md#sectionqcomplaint)                           | → |                              | Masternode sends the requested complaints
...
|                                                | ← | [`getdata` message](core-ref-p2p-network-data-messages.md#sectiongetdata) (qjustify) | Peer(s) respond with request for quorum justifications
| [`qjustify` message](core-ref-p2p-network-quorum-messages.md#sectionqjustify)                             | → |                              | Masternode sends the requested justifications
...
|                                                | ← | [`getdata` message](core-ref-p2p-network-data-messages.md#sectiongetdata) (qpcommit) | Peer(s) respond with request for quorum premature commitment
| [`qpcommit` message](core-ref-p2p-network-quorum-messages.md#sectionqpcommit)                             | → |                              | Masternode sends the requested premature commitment
...
|                                                | ← | [`getdata` message](core-ref-p2p-network-data-messages.md#sectiongetdata) (qfcommit) | Peer(s) respond with request for quorum final commitment
| [`qfcommit` message](core-ref-p2p-network-quorum-messages.md#sectionqfcommit)                             | → |                              | Masternode sends the requested final commitment
...
| [`qsigsesann` message](core-ref-p2p-network-quorum-messages.md#sectionqsigsesann)                             | → |                              | Masternode sends a signing session announcement _to other masternodes in the quorum_
...
| [`qsigsinv` message](core-ref-p2p-network-quorum-messages.md#sectionqsigsinv)                             | → |                              | Masternode sends one or more quorum signature share inventories _to other masternodes in the quorum_<br>_May occur multiple times in this phase_
|                                                | ← | [`qgetsigs` message](core-ref-p2p-network-quorum-messages.md#sectionqgetsigs) (qcontrib) | Peer(s) respond with request for signature shares<br>_May occur multiple times in this phase_
| [`qbsigs` message](core-ref-p2p-network-quorum-messages.md#sectionqbsigs)                             | → |                              | Masternode sends the requested batched signature share(s)<br>_May occur multiple times in this phase_
...
| [`qsigrec` message](core-ref-p2p-network-quorum-messages.md#sectionqsigrec)                             | → |                              | Masternode sends the quorum recovered signature **to all peers** (except those that have asked to be excluded via a [`qsendrecsigs` message](core-ref-p2p-network-quorum-messages.md#sectionqsendrecsigs))
