...
[/block]
The [`generate` RPC](core-api-ref-remote-procedure-calls-generating.md#sectiongenerate) mines blocks immediately (before the RPC call returns).
...
* [GenerateToAddress](/docs/core-api-ref-remote-procedure-calls-generating.md#sectiongenerate-to-address): mines blocks immediately to a specified address.
...
* [GetGenerate](/docs/core-api-ref-remote-procedure-calls-removed.md#sectionget-generate): was removed in Dash Core 0.12.3.
...
The [`generatetoaddress` RPC](core-api-ref-remote-procedure-calls-generating.md#sectiongenerate-to-address) mines blocks immediately to a specified address.
