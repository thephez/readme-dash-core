...
The [`bls` RPC](core-api-ref-remote-procedure-calls-evo.md#sectionbls) provides a set of commands to execute BLS-related actions.
...
The [`protx` RPC](core-api-ref-remote-procedure-calls-evo.md#sectionpro-tx) provides a set of commands to execute ProTx related actions.
...
The [`quorum` RPC](core-api-ref-remote-procedure-calls-evo.md#sectionquorum) provides a set of commands for quorums (LLMQs).
...
The [`quorum` RPC](core-api-ref-remote-procedure-calls-evo.md#sectionquorum) checks which quorums the given masternode is a member of.
