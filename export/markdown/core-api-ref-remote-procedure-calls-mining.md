...
The [`getblocktemplate` RPC](core-api-ref-remote-procedure-calls-mining.md#sectionget-block-template) gets a block template or proposal for use with mining software. For more
...
The [`getmininginfo` RPC](core-api-ref-remote-procedure-calls-mining.md#sectionget-mining-info) returns various mining-related information.
