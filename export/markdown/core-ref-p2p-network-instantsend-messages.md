...
The following annotated hexdump shows a [`clsig` message](core-ref-p2p-network-instantsend-messages.md#sectionclsig). (The message header has been omitted.)
...
The following annotated hexdump shows a [`islock` message](core-ref-p2p-network-instantsend-messages.md#sectionislock). (The message header has been omitted.)
