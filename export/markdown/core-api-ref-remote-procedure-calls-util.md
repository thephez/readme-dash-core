...
The [`createmultisig` RPC](core-api-ref-remote-procedure-calls-util.md#sectioncreate-multi-sig) creates a P2SH multi-signature address.
...
{
  "type": "warning",
  "body": "As of Dash Core 0.16.0, using addresses with `createmultisig` is deprecated. Clients must transition to using [`addmultisigaddress`](core-api-ref-remote-procedure-calls-wallet.md#sectionadd-multi-sig-address) to create multisig addresses with addresses known to the wallet before upgrading to v0.17. To use the deprecated functionality in 0.16.0, start dashd with `-deprecatedrpc=createmultisig`.",
...
* [AddMultiSigAddress](/docs/core-api-ref-remote-procedure-calls-wallet.md#sectionadd-multi-sig-address): adds a P2SH multisig address to the wallet.
...
The [`estimatefee` RPC](core-api-ref-remote-procedure-calls-util.md#sectionestimate-fee) estimates the transaction fee per kilobyte that needs to be paid for a transaction to begin confirmation within a certain number of blocks.
...
* [SetTxFee](/docs/core-api-ref-remote-procedure-calls-wallet.md#sectionset-tx-fee): sets the transaction fee per kilobyte paid by transactions created by this wallet.

# EstimateSmartFee

The [`estimatesmartfee` RPC](core-api-ref-remote-procedure-calls-util.md#sectionestimate-smart-fee) estimates the transaction fee per kilobyte that needs to be paid for a transaction to begin confirmation within a certain number of blocks and returns the number of blocks for which the estimate is valid.
...
The [`signmessagewithprivkey` RPC](core-api-ref-remote-procedure-calls-util.md#sectionsign-message-with-priv-key) signs a message with a given private key.
...
* [SignMessage](/docs/core-api-ref-remote-procedure-calls-wallet.md#sectionsign-message): signs a message with the private key of an address.
* [VerifyMessage](/docs/core-api-ref-remote-procedure-calls-util.md#sectionverify-message): verifies a signed message.

# ValidateAddress

The [`validateaddress` RPC](core-api-ref-remote-procedure-calls-util.md#sectionvalidate-address) returns information about the given Dash address.
...
The [`verifymessage` RPC](core-api-ref-remote-procedure-calls-util.md#sectionverify-message) verifies a signed message.
...
Name | Type | Presence | Description
--- | --- | --- | ---
Signature | string (base64) | Required<br>(exactly 1) | The signature created by the signer encoded as base-64 (the format output by the [`signmessage` RPC](core-api-ref-remote-procedure-calls-wallet.md#sectionsign-message))
