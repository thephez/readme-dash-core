...
The devnet name is put into the sub-version of the [`version` message](core-ref-p2p-network-control-messages#section-version). If a node connects to the wrong network, it will immediately be disconnected.
