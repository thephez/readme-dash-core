...
To create a multiple-signature (<<glossary:multisig>>) output, they each give the others a public key. Then Bob creates the following <<glossary:P2SH multisig>> redeem script:
